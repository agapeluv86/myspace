                ...
                <div class="row g-5">
                            ...
                            <div class="row g-4">
                                <div class="col-md-6 col-lg-6 col-xl-5">
                                    <div class="footer-item">
                                        <a href="index.html" class="p-0">
                                            <h3 class="text-white"><i class="fab fa-slack me-3"></i> Olushola</h3>
                                            <!-- <img src="img/logo.png" alt="Logo"> -->
                                        </a>
                                        <p class="text-white mb-4">As a full-stack software developer, I am proficient in both front-end and back-end technologies, with expertise in PHP, HTML, CSS, JavaScript, jQuery, and Bootstrap, allowing me to create.....</p>
                                ...
                                <div class="col-md-6 col-lg-6 col-xl-3">
                                    <div class="footer-item">
                                       ...
                                       <a href="service.php"><i class="fas fa-angle-right me-2"></i> Skills</a>
                                        ...
                                        <div class="col-lg-6 col-xl-4">
                                            <div class="d-flex">
                                                ...
                                                <div>
                                                    ...
                                                    <p class="mb-0">32, Allen Ikeja, Lagos state</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-xl-4">
                                            <div class="d-flex">
                                                <div class="btn-xl-square bg-primary text-white rounded p-4 me-2">
                                                    <i class="fas fa-envelope fa-2x"></i>
                                                </div>
                                                <div>
                                                    <h4 class="text-white">Mail Us</h4>
                                                    <p class="mb-0">owainternational@gmail.com</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-xl-4">
                    ...
                    <div class="col-xl-3">
                        <div class="footer-item">
                            ...
                            <p class="text-white mb-3">Time Management. As a certified full stack developer, you must simultaneously carry out many job responsibilities.</p>
                            ...
                            <div class="d-flex flex-shrink-0">
                                ...
                                <div class="d-flex flex-column ms-3 flex-shrink-0">
                                    <span>Call</span>
                                    <a href="tel:+ 0123 456 7890"><span class="text-white">Free: (+234) 8160319453</span></a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row g-4 align-items-center">
                    <div class="col-md-6 text-center text-md-end mb-md-0">
                        <span class="text-body"><a href="#" class="border-bottom text-white"><i class="fas fa-copyright text-light me-2"></i>2024 Agape Nigeria Limited</a>, All right reserved.</span>
                    </div>
